	...
	$scope.weekdays = new Array(7);
      ...
      $scope.Countrys = response.data;
		...
		$scope.fillTextbox=function(key,LocalizedName){
			...
			var d;
			var n
			var str3 = "http://dataservice.accuweather.com/forecasts/v1/daily/5day/";
			var str2 = str3.concat($scope.countryKey);
			var str4 = str2.concat("?apikey=aXxAHMl5WAJu82fE3BZaqT1QFSubtRnL ");
			 ...
			 str3 = "http://dataservice.accuweather.com/currentconditions/v1/";
			 str2 = str3.concat($scope.countryKey);
			 str4 = str2.concat("?apikey=aXxAHMl5WAJu82fE3BZaqT1QFSubtRnL  ");
			$http.get(str4).then(function(response) {
